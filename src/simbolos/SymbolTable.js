...
const ConstantSymbol = require('./ConstantSymbol');
...
class SymbolTable {
   ...
   */
  initBuiltin() {
    this.define(TypeSymbol.create('inteiro'));
    this.define(TypeSymbol.create('logico'));
    this.define(ConstantSymbol.create('verdadeiro', 'logico'));
    this.define(ConstantSymbol.create('falso', 'logico'));
    this.define(ProcedureSymbol.create('escreva', []));
    this.define(ProcedureSymbol.create('leia', []));
    return this;
  }
